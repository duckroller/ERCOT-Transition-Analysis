...
eGRID2000_plant <- read_excel("eGRID_files/eGRID2000_plant.xls", 
...
eGRID2004_plant <- read_excel("eGRID_files/eGRID2004_plant.xls", sheet = "EGRDPLNT04", skip = 4)
```
...
```{r}
eGRID2005_plant <- read_excel("eGRID_files/eGRID2005_plant.xls", sheet = "PLNT05", skip = 4)
...
```{r}
eGRID2007_plant <- read_excel("eGRID_files/eGRID2007_plant.xls", sheet = "PLNT07", skip = 4)
...
```{r}
eGRID2009_plant <- read_excel("eGRID_files/eGRID2009_data.xls", sheet = "PLNT09", skip = 4)
...
```{r}
eGRID2010_plant <- read_excel("eGRID_files/eGRID2010_Data.xls", sheet = "PLNT10", skip = 4)
...
```{r}
eGRID2012_plant <- read_excel("eGRID_files/eGRID2012_Data.xlsx", sheet = "PLNT12", skip = 4)
...
```{r}
eGRID2014_plant <- read_excel("eGRID_files/eGRID2014_Data_v2.xlsx", sheet = "PLNT14", skip = 1)
...
```{r}
eGRID2016_plant <- read_excel("eGRID_files/eGRID2016_data.xlsx", sheet = "PLNT16", skip = 1)
...
```{r}
eGRID2018_plant <- read_excel("eGRID_files/eGRID2018_data.xlsx", sheet = "PLNT18", skip = 1)
...
```{r}
write.csv(eGRID_ercot,"eGRID_ercot.csv")
```
