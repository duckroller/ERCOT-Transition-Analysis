...
eGRID_wide_aggregate <- dcast(setDT(nameplate_agg), year ~ fuel_type, value.var = c("nameplate_capacity.min_val","nameplate_capacity.max_val","nameplate_capacity.mean_val","nameplate_capacity.sum_val"), sep=".") 
